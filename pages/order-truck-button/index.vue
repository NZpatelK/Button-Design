<template>
    <div class="truck-butoon-ccontainer">
        <button :class="{'truck-button': true, 'done': buttonState.done, 'animation': buttonState.animation}" @click="handleOrderClick">
...
const buttonState = ref({ animation: false, done: false });

const handleOrderClick = () => {
  if (!buttonState.value.done) {
    if (!buttonState.value.animation) {
      buttonState.value.animation = true;
      const buttonEl = document.querySelector('.truck-button');
      const box = buttonEl.querySelector('.box');
      const truck = buttonEl.querySelector('.truck');
    ...
    buttonState.value.animation = false;
    buttonState.value.done = false;
    const buttonEl = document.querySelector('.truck-button');
    const box = buttonEl.querySelector('.box');
    const truck = buttonEl.querySelector('.truck');
